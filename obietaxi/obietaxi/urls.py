...
urlpatterns = patterns(
    ...
    url( r'^offer/proposal/(?P<ride_response>accept|decline)/(?P<ride_offer>[a-z0-9]+)/(?P<ride_request>[a-z0-9]+)/$',
         views.process_ask_for_ride, name="process_ask_for_ride" ),
    ...
    url( r'^offer/feedback/(?P<offer_id>[a-z0-9]+)/$', views.driver_feedback, name="driver_feedback" ),
    ...
    url( r'^request/proposal/(?P<ride_response>accept|decline)/(?P<ride_offer>[a-z0-9]+)/(?P<ride_request>[a-z0-9]+)/$',
         views.process_offer_ride, name="process_offer_ride" ),

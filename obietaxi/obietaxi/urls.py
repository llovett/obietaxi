...
urlpatterns = patterns('',
                       ...
                       url( r'^offer/cancel/(?P<offer_id>[a-z0-9]+)/$', views.cancel_offer, name="cancel_offer"),
                       ...
                       url( r'^request/cancel/(?P<request_id>[a-z0-9]+)/$', views.cancel_request, name="cancel_request"),

...
urlpatterns = patterns('',
                       ...
                       url( r'^offer/options/(?P<offer_id>[a-z0-9]+)/$', views.offere_options, name="offer_options" ),
                       ...
                       url( r'^request/options/(?P<request_id>[a-z0-9]+)/$', views.request_options, name="request_options" ),

...
(function () {
	...
	var dropdownButtonSize = inputHeight - sizeDelta;
        ...
        var showSelectorButton = jQuery(
            ...
            'style="position:absolute; height:'+dropdownButtonSize+'px; width:'+
            dropdownButtonSize+'px; top:'+(sizeDelta/2.0)+'px; right:'+(dropdownButtonSize+(sizeDelta/2.0))+'px;"><div class="combobox_arrow"></div></a>'
        );
